          ...
          <section className="space-y-3">
            ...
            {showFormEvento && (
              <EventoForm
                ...
                onClose={() => { setShowFormEvento(false); setFormEvento(eventoFormVacio); }}
              />
            )}
            ...
            {loadingEventos ? (
              ...
              {showCobroEventos && (
                <CobroEventosForm
                  eventos={eventosAgenda.filter((ev) => eventosSeleccionados.has(ev.id))}
                  cobroEv={cobroEv}
                  setCobEv={setCobEv}
                  guardando={guardandoCobroEv}
                  onConfirmar={registrarCobroEventos}
                  onClose={() => setShowCobroEventos(false)}
                />
              )}
              </>
            )}
