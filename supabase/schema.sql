...
\restrict bLFiI2gJxCPR6Gu0tKeXZckNOKi4uPtXpuUI8PvHwU5eufuURE5elGUUNS6iYrf
...
--
-- Name: actualizar_ejecucion_al_cobrar(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.actualizar_ejecucion_al_cobrar() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
declare
  v_mes integer;
...
--
-- Name: admin_set_user_profile(uuid, text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.admin_set_user_profile(target_user_id uuid, p_nombre text, p_apellido text, p_rol text, p_email text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  calling_role TEXT;
...
--
-- Name: get_my_rol(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: registrar_cobro_eventos(bigint, uuid, uuid, bigint, text, text, date, uuid[], text, text, text, text, text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.registrar_cobro_eventos(p_cliente_id bigint, p_ejecutivo_id uuid, p_registrado_por uuid, p_monto bigint, p_metodo_pago text, p_modalidad text, p_fecha_cobro date, p_eventos_ids uuid[], p_razon_social_factura text DEFAULT NULL::text, p_ruc_factura text DEFAULT NULL::text, p_lugar_evento text DEFAULT NULL::text, p_direccion_evento text DEFAULT NULL::text, p_email_contacto text DEFAULT NULL::text, p_telefono_contacto text DEFAULT NULL::text, p_referencia text DEFAULT NULL::text, p_notas text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql
...
--
-- Name: registrar_cobro_local(bigint, uuid, uuid, bigint, text, text, date, date, date, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.registrar_cobro_local(p_cliente_id bigint, p_ejecutivo_id uuid, p_registrado_por uuid, p_monto bigint, p_metodo_pago text, p_modalidad text, p_fecha_cobro date, p_periodo_desde date DEFAULT NULL::date, p_periodo_hasta date DEFAULT NULL::date, p_referencia text DEFAULT NULL::text, p_notas text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: cliente_lead_scores; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.cliente_lead_scores AS
 SELECT cliente_id,
...
--
-- Name: clientes_numero_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: cobros_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: ejecucion_meta; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ejecucion_meta (
    id bigint NOT NULL,
    ejecutivo_id uuid NOT NULL,
...
--
-- Name: ejecucion_meta_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda_numero_evento_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: historial_instancias; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.historial_instancias (
    id bigint NOT NULL,
    cliente_id bigint NOT NULL,
...
--
-- Name: historial_instancias_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: instancias_log; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.instancias_log (
    id bigint NOT NULL,
    cliente_id bigint NOT NULL,
    instancia_anterior text,
    instancia_nueva text NOT NULL,
...
--
-- Name: instancias_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: rubros_evento; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.rubros_evento (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    nombre text NOT NULL,
...
--
-- Name: sub_rubros; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.sub_rubros (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: tarea_completada; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tarea_completada (
    id bigint NOT NULL,
    cliente_id bigint NOT NULL,
...
--
-- Name: tarea_completada_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: tipos_resultado; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tipos_resultado (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    nombre text NOT NULL,
...
--
-- Name: ejecucion_meta ejecucion_meta_ejecutivo_id_mes_anio_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ejecucion_meta ejecucion_meta_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda eventos_agenda_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: historial_instancias historial_instancias_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: instancias_log instancias_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: metas metas_ejecutivo_id_mes_anio_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rubros rubros_categoria_id_nombre_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rubros_evento rubros_evento_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rutas rutas_ejecutivo_id_fecha_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sub_rubros sub_rubros_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tarea_completada tarea_completada_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tipos_resultado tipos_resultado_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_clientes_ejecutivo; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_clientes_instancia; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cobros_cliente; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cobros_fecha; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gestiones_cliente; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gestiones_ejecutivo; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gestiones_fecha; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: cobros on_cobro_registrado; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER on_cobro_registrado AFTER INSERT ON public.cobros FOR EACH ROW EXECUTE FUNCTION public.actualizar_ejecucion_al_cobrar();
...
--
-- Name: clientes clientes_categoria_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: clientes clientes_ejecutivo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: clientes clientes_etapa_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: clientes clientes_rubro_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: clientes clientes_sub_rubro_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: clientes clientes_supervisor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cobros cobros_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cobros cobros_ejecutivo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cobros cobros_registrado_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ejecucion_meta ejecucion_meta_ejecutivo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda eventos_agenda_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda eventos_agenda_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda eventos_agenda_ejecutivo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda eventos_agenda_rubro_evento_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gestiones gestiones_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gestiones gestiones_ejecutivo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gestiones gestiones_etapa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gestiones gestiones_evento_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gestiones gestiones_resultado_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gestiones gestiones_tarea_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: historial_instancias historial_instancias_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: historial_instancias historial_instancias_ejecutivo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: instancias_log instancias_log_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: instancias_log instancias_log_ejecutivo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: instancias_log instancias_log_supervisor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: metas metas_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: metas metas_ejecutivo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rubros rubros_categoria_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rutas rutas_ejecutivo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sub_rubros sub_rubros_rubro_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tarea_completada tarea_completada_aprobada_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tarea_completada tarea_completada_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tarea_completada tarea_completada_ejecutivo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tarea_completada tarea_completada_etapa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tarea_completada tarea_completada_tarea_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tareas tareas_etapa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: profiles Admin crea perfiles; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: categorias Admin gestiona categorias; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: etapas Admin gestiona etapas; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rubros Admin gestiona rubros; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: tareas Admin gestiona tareas; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: metas Admin y supervisor gestionan metas; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: historial_instancias Autenticados pueden insertar historial; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: historial_instancias Autenticados pueden leer historial; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: clientes Crear clientes; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: clientes Editar clientes; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles Editar propio perfil; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rutas Gestionar rutas propias; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: notificaciones Insertar notificaciones; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: categorias Lectura libre categorias; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rubros Lectura libre rubros; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: notificaciones Marcar como leída; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cobros Registrar cobros; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: gestiones Registrar gestiones; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: instancias_log Registrar instancias log; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: tarea_completada Registrar tareas completadas; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ejecucion_meta Sistema actualiza ejecucion; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: clientes Ver clientes; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cobros Ver cobros; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ejecucion_meta Ver ejecucion propia; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: etapas Ver etapas; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: gestiones Ver gestiones propias o supervisor; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: instancias_log Ver instancias log; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: metas Ver metas propias; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: notificaciones Ver propias notificaciones; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rutas Ver rutas propias; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: tareas Ver tareas; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: tarea_completada Ver tareas completadas; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: tipos_resultado admin modifica tipos_resultado; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles admins_pueden_actualizar_perfiles; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ejecucion_meta; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.ejecucion_meta ENABLE ROW LEVEL SECURITY;

--
-- Name: clientes ejecutivo_actualiza_censo_propio; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.eventos_agenda ENABLE ROW LEVEL SECURITY;

--
-- Name: eventos_agenda eventos_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda eventos_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda eventos_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: sub_rubros gestion_sub_rubros; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: gestiones; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.gestiones ENABLE ROW LEVEL SECURITY;

--
-- Name: historial_instancias; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.historial_instancias ENABLE ROW LEVEL SECURITY;

--
-- Name: instancias_log; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.instancias_log ENABLE ROW LEVEL SECURITY;

--
-- Name: sub_rubros lectura_sub_rubros; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rubros_evento manage_rubros_evento; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: tipos_evento manage_tipos_evento; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles managers_read_all_profiles; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rubros_evento read_rubros_evento; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: tipos_evento read_tipos_evento; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rubros_evento; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: sub_rubros; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.sub_rubros ENABLE ROW LEVEL SECURITY;

--
-- Name: tarea_completada; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: tipos_evento; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.tipos_evento ENABLE ROW LEVEL SECURITY;

--
-- Name: tipos_resultado; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.tipos_resultado ENABLE ROW LEVEL SECURITY;

--
-- Name: tipos_resultado todos leen tipos_resultado; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: eventos_agenda update_eventos_agenda; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: objects Autenticados pueden ver fotos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Autenticados pueden ver fotos" ON storage.objects FOR SELECT TO authenticated USING ((bucket_id = 'gestiones-fotos'::text));


--
-- Name: objects Ejecutivos pueden subir fotos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Ejecutivos pueden subir fotos" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'gestiones-fotos'::text));
...
\unrestrict bLFiI2gJxCPR6Gu0tKeXZckNOKi4uPtXpuUI8PvHwU5eufuURE5elGUUNS6iYrf
